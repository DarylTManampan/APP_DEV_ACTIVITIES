...
This project is a **PHP-based web application** that shows simple **CRUD** (Create, Read, Update, Delete) functionality for managing music playlists and the songs they contain. It is built with Bootstrap for a responsive UI and uses PDO for secure database interactions.
