            ...
            <div id="mycarousel" class="carousel slide" data-ride="carousel" style="width:1000px;">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="pic/mypic2.jpg" width="1000px" height="1000px">
                    ...
                    <div class="item">
                        <img src="pic/mypic1.jpg" width="1000px" height="1000px">
                        <div class="carousel-caption">
                            <h3 class="text-success">My Second Pic</h3>
                            <p class="text-info">THIS IS SPONGEBOB</p>
                        </div>
                    </div>
                    <div class="item">
                        <img src="pic/mypic3.jpg" width="1000px" height="1000px">
                        <div class="carousel-caption">
                            <h3 class="text-danger">My Third Pic</h3>
                            <p class="text-danger">THIS IS SANDY</p>
                        </div>
                    </div>
